...
\begin{axis}[
   ...
   \addplot[red!10, forget plot] fill between[of=top2 and bot2];
    ...
    table[x = Iterations,
     ...
     % std 
    \addplot[name path=top3, color=violet!30, no markers, forget plot]
    table[x=Iterations,
    y = Rets_sup]{\gpomdpapprox};

    
    % std
    \addplot[name path=bot3, color=violet!30, no markers, smooth, forget plot]
    table[x=Iterations,
    y=Rets_low]{\gpomdpapprox};
    
    % fill
   \addplot[violet!10, forget plot] fill between[of=top3 and bot3];
